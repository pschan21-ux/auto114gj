...
(function () {
  ...
  var D = {
    ...
    '성능·상태점검기록부는 현재 준비 중입니다.': ['The performance & condition inspection report is being prepared.', 'Отчёт о техническом состоянии готовится.', '性能·状态检查记录簿正在准备中。', 'Biên bản kiểm tra tình trạng đang được chuẩn bị.', 'يجري إعداد تقرير فحص الأداء والحالة.'],
    '전화로 문의해 주시면 즉시 보내드리며, 차량 인도 전 반드시 교부해 드립니다.': ['Call us and we will send it right away; it is always provided before delivery.', 'Позвоните нам — вышлем сразу; документ обязательно выдаётся до передачи авто.', '致电我们可立即发送，交车前必定交付。', 'Gọi cho chúng tôi để nhận ngay; luôn được cấp trước khi giao xe.', 'اتصل بنا لنرسله فورًا، ويُسلَّم دائمًا قبل تسليم السيارة.'],
