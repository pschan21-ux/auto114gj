...
(function () {
  ...
  var D = {
    ...
    '직접매입으로 검증된 매물 · 총 41대 보유': ['Directly purchased, verified stock', 'Проверенные авто прямого выкупа', '直接收购的认证车源', 'Xe đã kiểm định, mua trực tiếp', 'سيارات موثوقة تم شراؤها مباشرة'],
