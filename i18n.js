...
(function () {
  ...
  var D = {
    ...
    '직접매입으로 검증된 매물 · 총 43대 보유': ['Directly purchased, verified stock', 'Проверенные авто прямого выкупа', '直接收购的认证车源', 'Xe đã kiểm định, mua trực tiếp', 'سيارات موثوقة تم شراؤها مباشرة'],
    ...
    '무사고 (단순수리 있음 / 도어 교환)': ['No accidents (minor repairs / door replaced)', 'Без ДТП (мелкий ремонт / замена двери)', '无事故(有简单维修/更换车门)', 'Không tai nạn (sửa chữa nhỏ / đã thay cửa)', 'بدون حوادث (إصلاحات بسيطة / تم استبدال الباب)'],
    ...
    '승차정원': ['Seating capacity', 'Число мест', '乘坐人数', 'Số chỗ ngồi', 'عدد المقاعد'],
    ...
    '커튼 에어백': ['Curtain airbags', 'Шторки безопасности', '侧气帘', 'Túi khí rèm', 'وسائد هوائية ستارية'],
    '4단 자동변속기 & 후드인슐레이션': ['4-speed automatic & hood insulation', '4-ступенчатый автомат и шумоизоляция капота', '4速自动变速器及发动机盖隔音', 'Hộp số tự động 4 cấp & cách âm nắp capo', 'ناقل أوتوماتيكي 4 سرعات وعزل غطاء المحرك'],
    ...
    '경형': ['Light-class', 'Малый класс', '轻型', 'Hạng nhẹ', 'فئة خفيفة'],
    '면제': ['Exempt', 'Освобождено', '免征', 'Miễn', 'معفى'],
    '경형 승용 : 면제': ['Light passenger: Exempt', 'Легковой малого класса: освобождено', '轻型轿车：免征', 'Xe con hạng nhẹ: Miễn', 'سيارة ركاب خفيفة: معفى'],
    '경형 : 면제': ['Light-class: Exempt', 'Малый класс: освобождено', '轻型：免征', 'Hạng nhẹ: Miễn', 'فئة خفيفة: معفى'],
    '승용 (경형 SUV)': ['Passenger (Light SUV)', 'Легковой (малый SUV)', '轿车（轻型SUV）', 'Xe con (SUV hạng nhẹ)', 'ركاب (SUV خفيفة)'],
    ...
    '자동변속기': ['Automatic transmission', 'Автоматическая коробка передач', '自动变速器', 'Hộp số tự động', 'ناقل حركة أوتوماتيكي'],
    '전동 사이드 미러': ['Power side mirrors', 'Электрические боковые зеркала', '电动后视镜', 'Gương chỉnh điện', 'مرايا جانبية كهربائية'],
    '가죽 스티어링 휠': ['Leather steering wheel', 'Кожаный руль', '真皮方向盘', 'Vô lăng bọc da', 'مقود جلدي'],
    '뒷유리 열선': ['Rear window defroster', 'Обогрев заднего стекла', '后窗除雾', 'Sấy kính sau', 'مزيل ضباب الزجاج الخلفي'],
    '안개등': ['Fog lamps', 'Противотуманные фары', '雾灯', 'Đèn sương mù', 'مصابيح الضباب'],
    '휠 커버': ['Wheel covers', 'Колпаки колёс', '轮毂盖', 'Ốp la-zăng', 'أغطية العجلات'],
    '검사유효기간': ['Inspection valid', 'Срок техосмотра', '检验有效期', 'Hạn kiểm định', 'صلاحية الفحص'],
    '무사고 (단순수리 없음)': ['No accidents (no repairs)', 'Без ДТП (без ремонта)', '无事故(无维修)', 'Không tai nạn (không sửa chữa)', 'بدون حوادث (بدون إصلاحات)'],
    '승용 (경형 해치백)': ['Passenger (Light hatchback)', 'Легковой (малый хэтчбек)', '轿车（轻型两厢）', 'Xe con (hatchback hạng nhẹ)', 'ركاب (هاتشباك خفيفة)'],
    '렌트·영업용 이력 없음': ['No rental or commercial use', 'Без аренды и коммерческого использования', '无租赁·营运记录', 'Không có lịch sử cho thuê hoặc kinh doanh', 'لا يوجد تاريخ تأجير أو استخدام تجاري'],
  ...
  var WORD = {
    ...
    '렉스턴스포츠 칸': 'Rexton Sports Khan', '렉스턴스포츠': 'Rexton Sports', '렉스턴': 'Rexton', '어드벤처': 'Adventure', '와일드': 'Wild',
    '스타리아': 'Staria', '투어러': 'Tourer', '쏘렌토R': 'Sorento R', '최고급형': 'Top Grade',
    ...
    '더뉴': 'The New', '더 뉴': 'The New', '디 올 뉴': 'The All-New', '디올뉴': 'The All-New', '올뉴': 'All-New', '어메이징 뉴': 'Amazing New', '어메이징': 'Amazing',
    '신형': 'New', '뉴': 'New',
